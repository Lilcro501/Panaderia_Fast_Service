...
const productCategories = {
  panes: [
    ...
    { id: 'pan4', nameProduct: 'Galleta Chocolate', price: 2200, quantity: 0, image: GalletaChoco, description: 'Galleta crujiente con trozos de chocolate.' },
    { id: 'pan5', nameProduct: 'Galleta Mermelada', price: 2200, quantity: 0, image: GalletaMermelada, description: 'Galleta suave rellena con deliciosa mermelada.' },
    { id: 'pan6', nameProduct: 'Lengua', price: 1700, quantity: 0, image: Lengua, description: 'Pan en forma de lengua, crujiente y dulce.' },
    { id: 'pan7', nameProduct: 'Magdalena', price: 800, quantity: 0, image: Magdalena, description: 'Magdalena tradicional, esponjosa y ligera.' },
    { id: 'pan8', nameProduct: 'PanAgridulce', price: 1200, quantity: 0, image: PanAgridulce, description: 'Pan con un toque agridulce, suave y sabroso.' },
    ...
    { id: 'pan10', nameProduct: 'Pera', price: 2300, quantity: 0, image: Pera, description: 'Pan con forma de pera y sabor único.' },
    { id: 'pan11', nameProduct: 'Rollo', price: 3000, quantity: 0, image: Rollo, description: 'Rollito de pan suave con un toque dulce.' }
  ],
  fritos: [
  ...
  mecato: [
    ...
    { id: 'm2', nameProduct: 'Cheetos', price: 3800, quantity: 0, image: Cheetos, description: 'Mecato de maíz con sabor a queso.' },
    { id: 'm3', nameProduct: 'Chokis', price: 1800, quantity: 0, image: Chokis, description: 'Galletas con chispas de chocolate.' },
    { id: 'm4', nameProduct: 'Detodito', price: 4000, quantity: 0, image: Detodito, description: 'Mezcla de snacks variados para todos los gustos.' },
    ...
    { id: 'm7', nameProduct: 'Flaming Hot', price: 4000, quantity: 0, image: FlamingHot, description: 'Snacks extra picantes para los más valientes.' },
