...
export default function PoliticaPrivacidad() {
    ...
    <section className='ContenedorContenido'>
        ...
        <div className='ContenedorInfo'>
            <h2 className='Subtitulo'>1. ¿Para qué sirve esta Política de Privacidad?</h2>
            ...
            <h2 className='Subtitulo'>2. ¿Quién es el responsable del tratamiento de tus Datos Personales?</h2>
            <div className='ContenedorParrafo'>
                <p className='Parrafo'>
                Los responsables y Destinatarios del Tratamiento de tus Datos Personales somos 
                la empresa FastService S.A.S. y la panadería La Orquídea A continuación, 
                puedes encontrar más información sobre nosotros:
                <br/><br/>
                ...
                al número +57 300 842 5119, de lunes a domingo de 8:00 am a 6:00 pm o enviando 
            ...
            <h2 className='Subtitulo'>3. ¿Dónde obtenemos tus Datos Personales? ¿Qué Datos vamos a utilizar exactamente?</h2>
            <div className='ContenedorParrafo'>
                <p className='Parrafo'>
                ...
                Para referirnos a toda la información anteriormente mencionada y a cualquier 
                otra que tengamos sobre ti utilizaremos el término “Datos Personales”.
            </div>
            <br/>

            <h2 className='Subtitulo'>4. ¿Para qué vamos a utilizar tus Datos Personales?</h2>
            <div className='ContenedorParrafo'>
                <p className='Parrafo'>
            ...
            <h2 className='Subtitulo'>5. ¿Durante cuánto tiempo conservaremos tus Datos Personales?</h2>
            <div className='ContenedorParrafo'>
                <p className='Parrafo'>
                    ...
                    especial capacidad de la panadería La Orquídea para atender dichas responsabilidades u obligaciones legales. Una vez prescriban estas posibles acciones y expiren las obligaciones legales mencionadas, procederemos a eliminar tus datos personales de forma definitiva.
                </p>
            </div>
            <br/>
            
            <h2 className='Subtitulo'>6. ¿Compartiremos tus Datos Personales con terceros?</h2>
            <div className='ContenedorParrafo'>
                <p className='Parrafo'>
                    En la panadería La Orquídea respetamos la privacidad de nuestros clientes, trabajadores, proveedores 
                    y usuarios de la web; por lo que, no compartiremos la información a terceros.
                </p>
            </div>
            <br/>
            
            <h2 className='Subtitulo'>7. ¿Cuáles son tus derechos en cuestiones de Protección de datos? DERECHOS ARCO</h2>
            <div className='ContenedorParrafo'>
                <p className='Parrafo'>
                    Como usuario de la panadería La Orquídea, dispones de una serie de derechos para que puedas decidir 
            ...
            <h2 className='Subtitulo'>8. ¿Actualizaremos esta Política de Privacidad?</h2>
            <div className='ContenedorParrafo'>
                <p className='Parrafo'>
